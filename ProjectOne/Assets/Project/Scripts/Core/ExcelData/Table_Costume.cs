...
namespace EDT {
    ...
    public static class Table_Costume
    {
        public class Row {
            ...
            public Currency CostCurrencyType { get; set; } = Currency.None;
            public int CostValue { get; set; } = 0;
        }

        public const string Filename = "edt_costume.bytes";
        public const TableType Type = TableType.TableCostume;
        ...
        public static bool _parser( BinaryReader reader, ref string error )
        {
            try {
                ...
                row.IsDefault = reader.ReadBoolean();
                row.CostCurrencyType = (Currency)reader.ReadInt32();
