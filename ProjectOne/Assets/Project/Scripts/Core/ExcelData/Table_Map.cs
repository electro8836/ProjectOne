...
namespace EDT {
    ...
    public static class Table_Map
    {
        ...
        public const string Filename = "edt_map.bytes";
        public const TableType Type = TableType.TableMap;
        ...
        public static bool _parser( BinaryReader reader, ref string error )
        {
            try {
                ...
                row.MapType = (MapType)reader.ReadInt32();
