...
namespace ProjectOne.UI
{
	...
	// 공통 버튼(나가기) 처리만 담당한다.
	public class DungeonHUD : UIScreen
	{
		[Header("위젯")]
		...
		// 상점 열기 버튼 클릭.
		// TODO(STEP 9) — 던전 내 상점 기믹은 던전 모드 재작성과 함께 붙인다.
		...
		{
			// Director 는 씬이 아니라 코드가 만든다 — 정적 인스턴스를 직접 쓴다.
			DungeonDirector director = DungeonDirector.Instance;
			if (director != null)
			{
