...
namespace ProjectOne.Skill
{
	...
	//
	// TODO — 대시 계열 코드 스킬(SkillDash / SkillDashAttack)은 대응하는 Skill ID 가 아직 테이블에 없어
	// 매핑하지 못했다. 스킬 데이터가 채워지면 여기에 등록한다.
	public static class SkillBehaviorRegistry
	{
		...
		{
			{ EDT.Skill.Skill_SummonSpark_Attack, () => new Skill_SummonSpark_Attack() },
		};
